...
/*   Updated: 2023/11/24 12:54:48 by Naomi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *process_buffer(char **remaining)
{
    ...
    newline_char = ft_strchr(*remaining, '\n'); //search for newline character, ptr now points to its location in the buffer.
...
/*
In the read_and_buffer function, remaining is used to store any unprocessed data from the previous read operation. This is the data that comes before the next newline character.

In the process_buffer function, remaining is used to store any data that comes after the first newline character in the buffer. This is the data that will be processed in the next call to get_next_line.
*/