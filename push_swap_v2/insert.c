...
/*   Updated: 2024/04/16 11:07:10 by Naomi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (track->pc_index_a > track->border_a) // number is in the bottom
...
{
	if (track->pc_index_b > track->border_b) // number is in the bottom
	{
